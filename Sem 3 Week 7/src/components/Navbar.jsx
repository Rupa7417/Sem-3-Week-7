...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-10">
      <div className="container mx-auto flex justify-between items-center py-8 md:px-20">
      ...
      >
        ...
        <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg overflow-hidden">
